                    ...
                    <div class="card-body">
                        <form name="createForm" id="createForm" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control <?php echo (isset($validation) && $validation->hasError('name'))?'is-invalid' : ''; ?>" placeholder="Enter the book name" value="<?php echo set_value('name',$book['title']);?>"/>
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="author" id="author" class="form-control <?php echo (isset($validation) && $validation->hasError('author'))?'is-invalid' : ''; ?>" placeholder="Enter the author name" value="<?php echo set_value('author',$book['author']);?>"/>
                                <?php
